...
[Gap Analysis](gap-analysis.md) for every point where the two diverge, and
[QDI Specification Feedback](qdi-spec-feedback.md) for open questions this
raised about the QDI spec itself.
...
QDI OQTOPUS is released under the [Apache License 2.0](https://github.com/snuffkin/qdi-oqtopus/blob/main/LICENSE).
